...
nuke.menu('Nuke').addCommand('Extra/Paste For Each Node', "PasteForEachNode.PasteForEachNode()", "ctrl+shift+v", shortcutContext=2)
...
toolbar.addCommand('Other/GUI', 'nuke.createNode(\'GUI\')')
...
##DgPerspLines
#nuke.menu('Nodes').addCommand('Extra/dgTools/PerspLines/dg_PerspLines','nuke.createNode("dg_PerspLines")','')
#nuke.menu('Nodes').addCommand('Extra/dgTools/PerspLines/dg_Horizon','dg_PerspLines_Horizon()','')
#nuke.menu('Nuke').addCommand('Extra/dgTools/PerspLines/Align camera for 2 selected nodes','dg_PerspLines_AlignCamera()', 'Shift+V')

##X_Tools
##m = toolbar.addMenu("X_Tools", icon="X_Tools.png")

##m.addCommand("X_Distort", "nuke.createNode(\"X_Aton\")", icon="X_Aton.png")
...
##Quickkey Gizmo   !!!!
##nuke.menu('Nodes').addCommand('ToolSets/keyer/QuickKey', "nuke.createNode(\"QuickKey\")" )

nuke.menu('Nodes').addCommand('ToolSets/2D/x_distort_2017', "nuke.createNode(\"X_Distort\")" )
