...
def autoBackdropBW(): 
    ...
    left, top, right, bottom = (-80, -80, 80, 80) 
    bdX += left 
    bdY += top 
    bdW += (right - left) 
    bdH += (bottom - top)
    ...
    numbers = [x / 100.0 for x in range(20,20,1)] + [x / 100.0 for x in range(25,51,2)]
